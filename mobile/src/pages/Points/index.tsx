...
// Informando formato do Array Items
interface Item {
    id: number;
    title: string;
    image_url: string;
...
const Points = () => {
    ...
    useEffect(() =>{
        ...
        async function loadPosition() {
            // Pegando localização atual do usuário
            let { status } = await Location.requestPermissionsAsync();

            if(status !== 'granted') {
                // Caso ele não tenha dado permissão
    ...
    // Get Items da minha API e alterando stado de Items
    useEffect(() =>{
    ...
    function handleNavigateToDetail(id : number) {
        // Se eu passo parâmetros para essa rota, já vamos ter todas essas informações no componente Datail
